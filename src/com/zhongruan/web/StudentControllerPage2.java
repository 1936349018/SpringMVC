...
//        mv.addObject("s1",new Student(3,"隔壁老王","18"));
        ...
        // 4. 可以借用注解： @ModelAttribute 实现响应
        // 方法形参的响应方式： 引用数据可以实现， 但是基本 类型只能响应原本的参数
        stu1.setId(2);
        stu1.setStuName("老王");
    ...
    public String getData2(){
        //  如果是针对客户端的ajax请求，需要给与数据响应

        // 1.  直接响应字符串， 传中文乱码
//        return "Java And 是最好的语言!";
...
//        return stu1;
        ...
        // 3.  直接响应集合
//        Student stu1 = new Student(2,"隔壁老王","18");
//        Student stu2 = new Student(3,"隔壁老许","19");
//        Student stu3 = new Student(4,"隔壁老陈","20");
